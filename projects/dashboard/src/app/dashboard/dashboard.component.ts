...
import { ChartAllModule, AccumulationChartAllModule, RangeNavigatorAllModule, IAccLoadedEventArgs, AccumulationTheme, ILoadedEventArgs, ChartTheme, IAccPointRenderEventArgs } from '@syncfusion/ej2-angular-charts';
